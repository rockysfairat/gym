...
export const membershipPricesSv = [
  {
    membershipName: "Bas",
    membershipDesc:
      "Tillgång till gymmet under ordinarie tider, användning av basutrustning och gruppträningslektioner.",
    membershipPrice: "$30",
    period: "/månad",
  },
  {
    membershipName: "Premium",
    membershipDesc:
      "Obegränsad tillgång till gymmet, inklusive premiumutrustning, gruppträningslektioner och ytterligare förmåner som handduksservice och tillgång till bastun.",
    membershipPrice: "$50",
    period: "/månad",
  },
  {
    membershipName: "Par",
    membershipDesc:
      "Samma förmåner som grundmedlemskapet för två personer (par eller vänner).",
    membershipPrice: "$55",
    period: "/månad",
  },
  {
    membershipName: "Student",
    membershipDesc:
      "Tillgång till gymmet för heltidsstudenter med giltig legitimation, under lågtrafik.",
    membershipPrice: "$25",
    period: "/månad",
  },
  {
    membershipName: "Senior",
    membershipDesc:
      "Tillgång till gymmet för seniorer från 65 år och äldre, inklusive specialklasser anpassade för seniorer.",
    membershipPrice: "$20",
    period: "/månad",
  },
  {
    membershipName: "Familj",
    membershipDesc:
      "Tillgång för en familj på upp till 4 medlemmar, inkluderar tillgång till gymmet och familjevänliga träningspass.",
    membershipPrice: "$80",
    period: "/månad",
  },
  {
    membershipName: "Dags pass",
    membershipDesc: "Tillgång till gym och faciliteter för en enda dag.",
    membershipPrice: "$10",
    period: "/dag",
  },
];
...
export let trainingPackagesPricesSv = [
  {
    packageDesc: "5 sessioner",
    packagePrice: "$200",
  },
  {
    packageDesc: "10 sessioner",
    packagePrice: "$350",
  },
  {
    packageDesc: "20 sessioner",
    packagePrice: "$600",
  },
];
...
export const equipmentSv = [
  {
    ...
    equipmentDesc:
      "Våra högteknologiska löpband ger en mångsidig konditionsträningsupplevelse. Kliv upp på den vadderade ytan, ställ in din takt och börja gå eller springa. Med justerbara lutningsalternativ kan du simulera olika terränger, och inbyggda träningsprogram hjälper dig att utmana dig själv och spåra dina framsteg. Oavsett om du siktar på att bränna kalorier, förbättra uthålligheten eller helt enkelt få ditt hjärta att pumpa, är löpbandet ett pålitligt och effektivt val.",
    equipmentImg: "/eqiupment/treadmill.png",
  },
  {
    equipmentItem: "Smith Machine",
    equipmentDesc:
      "Smith Machine är ett fantastiskt verktyg för riktad styrketräning. Med en guidad skivstång kan du utföra knäböj, bänkpress och en mängd andra sammansatta övningar med extra säkerhet. Den är idealisk för individer på alla konditionsnivåer, från nybörjare som vill bygga muskler till erfarna lyftare med fokus på form och stabilitet. Smith Machine är en stapelvara i vårt gym för att uppnå balanserade och effektiva styrkepass.",
    equipmentImg: "/eqiupment/smith_machine.png",
  },
  {
    equipmentItem: "Ellipstränare",
    equipmentDesc:
      "Upplev ett kraftfullt men ändå effektivt träningspass för hela kroppen med våra ellipstränare. Dessa maskiner ger en mjuk glidrörelse som engagerar både över- och underkroppen, vilket gör den perfekt för cardioentusiaster och de som återhämtar sig från skador. Ellipstralen är designad för att minimera ledspänningen samtidigt som den maximerar kaloriförbränningen, vilket gör den till ett utmärkt val för att uppnå kardiovaskulär kondition utan påverkan av traditionell löpning.",
    equipmentImg: "/eqiupment/elliptical_trainer.png",
  },
  {
    equipmentItem: "Fria vikter (hantlar och skivstänger)",
    equipmentDesc:
      "Vår omfattande samling av fria vikter inkluderar ett brett utbud av hantlar och skivstänger, som passar alla styrka. Fria vikter är avgörande för funktionell styrketräning, vilket gör att du kan arbeta med individuella muskelgrupper och utveckla balans och stabilitet. Från klassiska lockar till sammansatta lyft som marklyft och knäböj, vårt fria viktområde är ett mångsidigt utrymme för att bygga muskler och förbättra den totala styrkan.",
    equipmentImg: "/eqiupment/free_weights.png",
  },
  {
    equipmentItem: "Stationärcykel",
    equipmentDesc:
      "Den stationära cykeln erbjuder en bekväm och effektiv kardiovaskulär träning som är lätt för lederna. Ställ in din motståndsnivå, hoppa på sadeln och börja trampa. Övervaka din puls, distans och förbrända kalorier på den inbyggda konsolen. Den stationära cykeln är perfekt för intervallträning, steady-state konditionsträning, eller helt enkelt njuta av ett träningspass med låg effekt medan du tittar på dina favoritprogram eller läser.",
    equipmentImg: "/eqiupment/stationary_bike.png",
  },
  {
    equipmentItem: "Kabelmaskiner",
    equipmentDesc:
      "Våra kabelmaskiner tillhandahåller ett brett utbud av motståndsbaserade övningar som riktar sig mot specifika muskelgrupper från flera vinklar. Med justerbara remskivor kan du utföra en mängd olika övningar, inklusive kabelkorsningar, lat pulldowns och rader. Kabelmaskinerna erbjuder jämnt motstånd genom hela rörelseområdet, vilket gör dem idealiska för att bygga muskler, förbättra muskeldefinitionen och förbättra funktionell styrka.",
    equipmentImg: "/eqiupment/cable_machines.png",
  },
  {
    equipmentItem: "Benpressmaskinen",
    equipmentDesc:
      "Benpressmaskinen är din favorit för att utveckla starka underkroppsmuskler. Med en bekväm sits och en plattform att trycka mot, kan du rikta in dig på dina quadriceps, hamstrings och glutes effektivt. Benpressen är ett utmärkt alternativ för dem som vill bygga upp styrka i underkroppen utan att belasta ryggen, vilket gör den lämplig för både nybörjare och erfarna lyftare.",
    equipmentImg: "/eqiupment/leg_press_machine.png",
  },
  {
    equipmentItem: "Funktionellt träningsområde ",
    equipmentDesc:
      "Vårt funktionella träningsområde är ett dynamiskt utrymme designat för funktionella konditionsövningar. Från stridslinor och medicinbollar till TRX-fjädringstränare, detta område är perfekt för att förbättra den övergripande atleticism, balans och koordination. Våra tränare kan guida dig genom en mängd olika funktionella rörelser som efterliknar verkliga aktiviteter, och hjälper dig att utveckla en stark, smidig kropp som presterar bra i vardagliga sysslor och sporter.",
    equipmentImg: "/eqiupment/functional_training_area.png",
  },
];
...
export let staffSv = [
  {
    name: "Sarah Johnson",
    position: "Personlig tränare",
    desc: "Välkommen till träningsresan guidad av Sarah, vår mycket erfarna personliga tränare. Med en bakgrund inom tävlingsfriidrott och en examen i träningsvetenskap brinner Sarah för att skräddarsy träningsplaner efter individuella behov. Hon är skicklig på tyngdlyftning, funktionell träning och rehabiliteringsövningar. Sarahs mål är att hjälpa dig att nå din högsta fysiska kondition samtidigt som du säkerställer säkerhet och korrekt form. Gör dig redo att bli inspirerad, utmanad och bemyndigad när du arbetar mot dina träningsmål under hennes expertvägledning.",
    photo: "/staff/sarah.png",
  },
  {
    name: "David Ramirez",
    position: "Personlig tränare och grupptränare",
    desc: "Möt David, en karismatisk personlig tränare och gruppträningscoach med en känsla för motivation. Davids bakgrund inom dans och hans certifiering inom HIIT-träning skapar en unik blandning av nöje och effektivitet i hans sessioner. Som din personliga tränare kommer han att utveckla en skräddarsydd plan för att möta dina specifika mål, oavsett om det är att skulptera din kropp, förbättra konditionen eller öka din totala styrka. Gå med i hans gruppträningsklasser för att uppleva högenergipass som gör att du känner dig fullbordad och inspirerad.",
    photo: "/staff/david.png",
  },
  {
    name: "Emily Clark",
    position: "Personlig tränare och kostspecialist",
    desc: "Är du redo att förändra din livsstil? Säg hej till Emily, vår dedikerade personliga tränare och näringsspecialist. Med en magisterexamen i nutrition och en passion för fitness, tror Emily på ett holistiskt förhållningssätt till hälsa. Hon kommer att skapa ett personligt träningsprogram som är i linje med dina mål samtidigt som hon ger sunda näringsråd för att maximera resultaten. Från viktkontroll till att förbättra atletisk prestation, Emilys expertis inom både fitness och kost säkerställer en omfattande och hållbar väg till framgång.",
    photo: "/staff/emily.png",
  },
  {
    name: "Mike Turner",
    position: "Personlig tränare och fitnesscoach",
    desc: "Var dig redo att ge dig ut på en träningsresa med Mike, vår mångsidiga personliga tränare och fitnesscoach. Med en bakgrund inom styrka och kondition sträcker sig Mikes expertis från funktionell kondition till sportspecifik träning. Han är dedikerad till att hjälpa dig att uppnå dina konditionsambitioner, oavsett om det handlar om att bygga muskler, öka flexibiliteten eller förbättra den övergripande atletiska förmågan. Som din personliga tränare kombinerar Mike skräddarsydda träningsplaner med motiverande coachning för att få fram det bästa i dig.",
    photo: "/staff/mike.png",
  },
  {
    name: "Jessica Lee ",
    position: "Personlig tränare och friskvårdscoach",
    desc: "Jessica är inte bara en personlig tränare; hon är också din hängivna hälsocoach. Hennes holistiska inställning till fitness omfattar fysiskt, mentalt och känslomässigt välbefinnande. Med certifieringar inom yoga, meditation och stresshantering kommer Jessica att designa ett träningsprogram som inte bara förvandlar din kropp utan också förbättrar din övergripande livskvalitet. Genom personliga träningspass, mindfulness-tekniker och positiv förstärkning är Jessica engagerad i att hjälpa dig att uppnå en balanserad och hälsosam livsstil.",
    photo: "/staff/jessica.png",
  },
];
